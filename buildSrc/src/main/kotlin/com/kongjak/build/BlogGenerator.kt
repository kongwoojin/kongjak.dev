...
fun generateBlogMetadata(
    ...
    val outputDir = metadataDir.resolve("com/kongjak/kongjak/generated").apply { mkdirs() }
    val categoryPagesDir = metadataDir.resolve("com/kongjak/kongjak/pages/blog/categories").apply { mkdirs() }
...
private fun buildCategoryPageKt(slug: String, categoryTitle: String, className: String): String = buildString {
    ...
    appendLine("import com.kongjak.kongjak.components.sections.CrumbPart")
